...
function PostIcon({ active }: { active: boolean }) {
  return (
    <svg className="w-5 h-5" style={{ color: "var(--uber-white)" }} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
...
function HomeIcon({ active }: { active: boolean }) {
  return (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={active ? 2.2 : 1.8} viewBox="0 0 24 24" style={{ color: active ? "var(--uber-black)" : "var(--uber-muted)" }}>
...
function ChatIcon({ active }: { active: boolean }) {
  return (
    <svg className="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" strokeWidth={active ? 2.2 : 1.8} viewBox="0 0 24 24" style={{ color: active ? "var(--uber-black)" : "var(--uber-muted)" }}>
