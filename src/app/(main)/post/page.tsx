    ...
    return (
      ...
      >
        ...
        <p className="text-gray-500 text-sm mt-2 max-w-xs">
          Your {kind === "hostel" ? "hostel" : "property"} is now live. Seekers can contact you directly — no agents, no commission.
        </p>
        <div className="flex gap-3 mt-8">
          <button onClick={() => router.push("/dashboard")} className="bg-emerald-500 text-white font-bold px-6 py-3 rounded-2xl active:scale-95 transition-transform text-sm">
            View Dashboard
          </button>
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="bg-white px-4 pt-12 pb-4 border-b border-gray-100">
        ...
        <p className="text-xs text-gray-400 mt-0.5">No agents. Your listing, your price.</p>
          ...
          {currentStep === "Photos" && (
            <div className="space-y-5">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">Minimum {MIN_PHOTOS} · max 10 · tap ← → to reorder · first photo is your cover</p>
              </div>
              <div className="grid grid-cols-3 gap-2">
                {photos.map((f, i) => (
