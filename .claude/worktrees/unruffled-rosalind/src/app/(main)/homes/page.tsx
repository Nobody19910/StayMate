  ...
  return (
    <Link href={`/homes/${property.id}`}>
      <div
        ...
        style={{ boxShadow: "0 2px 16px rgba(0,0,0,0.07)", border: "0.5px solid var(--uber-border)", background: "var(--uber-white)", contain: "layout style paint", contentVisibility: "auto", containIntrinsicSize: "0 320px" }}
      >
        <div className="relative aspect-square w-full shrink-0" style={{ background: "var(--uber-surface2)" }}>
          ...
          />
          <span className="absolute top-2 left-2 text-[9px] font-bold uppercase px-1.5 py-0.5 rounded backdrop-blur-sm" style={{ background: "rgba(0,0,0,0.75)", color: "#fff" }}>
            {property.forSale ? "For Sale" : "Rent"}
          </span>
          {property.isSponsored && (
            <span className="absolute top-2 left-2 mt-5 text-[9px] font-bold uppercase px-1.5 py-0.5 rounded shimmer-gold text-[#111111]">
              <IconStar /> Sponsored
            </span>
          )}
          {property.isVerified && (
          ...
          {property.isNegotiable && (
            <span className="absolute bottom-2 left-2 text-[9px] font-bold uppercase px-1.5 py-0.5 rounded backdrop-blur-sm" style={{ background: "var(--uber-green)", color: "#ffffff" }}>
              Negotiable
            </span>
          )}
          <button
